...
# Veri seti yolları
train_dir = "C:/capstoneproject/firstData/train"
val_dir = "C:/capstoneproject/firstData/validation"
test_dir = "C:/capstoneproject/firstData/test"
...
def display_all_predicted_images(test_generator, true_classes, predicted_classes, class_labels, limit=100):
...
# Tahmin Edilen Görsellerin Gösterimi
display_all_predicted_images(test_generator, true_classes, predicted_classes, class_labels, limit=100)
